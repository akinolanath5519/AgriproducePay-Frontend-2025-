...
class StandardPurchasesScreen extends ConsumerStatefulWidget {
  const StandardPurchasesScreen({super.key});

  @override
  _StandardPurchasesScreenState createState() =>
      _StandardPurchasesScreenState();
}

class _StandardPurchasesScreenState
    extends ConsumerState<StandardPurchasesScreen> {
                ...
                child: Column(
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        TextButton(
                          ...
                          child: const Text('Download Report as CSV'),
                        ),
                      ],
                    ),
                    const SizedBox(height: 10),
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                               ...
                                               Text(
                                                ...
                                                const SizedBox(height: 4),
                                                Text(
                                                  'Price: ${NumberFormat('#,##0.00').format(transaction.price)}',
                                                  style: const TextStyle(
                                                    fontSize: 12,
                                                    fontWeight: FontWeight.bold,
                                                    color: Colors.black,
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          'Total Amt: ${NumberFormat('#,##0.00').format(totalPrice)}',
                          style: const TextStyle(
                              fontSize: 16, fontWeight: FontWeight.bold),
                        ),
                        const SizedBox(
                            width: 8), // Add some small space between the texts
                        Text(
